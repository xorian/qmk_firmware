...
[L_QW] = LAYOUT(
   ...
   KC_A,     ALT_T(KC_S), CTL_T(KC_D), SFT_T(KC_F),     KC_G, KC_TAB,    KC_TAB,  KC_H,    SFT_T(KC_J), CTL_T(KC_K), ALT_T(KC_L), MO(L_GL),
...
[L_GL] = LAYOUT(
   // left hand                                            // right hand
   _______, RGB_TOG,  RGB_VAI, RGB_HUI, RGB_SAI, _______,   _______, _______, _______, _______, _______, _______,
   _______, RGB_MOD,  RGB_VAD, RGB_HUD, RGB_SAD, _______,   _______, _______, _______, _______, _______, _______,
